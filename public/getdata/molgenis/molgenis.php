    ...
    <div class="page-wrapper">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- BEGIN PAGE TITLE-->
                <h1 class="page-title"> Central Molgenis outbox  &nbsp;&mdash;&nbsp; Datasets<br/><br/>
                <small> Molgenis datasets accessible through your account </small>
                </h1>
                <!-- END PAGE TITLE -->
                <!-- END PAGE HEADER -->
                          ...
                          <div id="loading-datatable" class="loadingForm" style="display:none;">
                            ...
                            <div class="portlet light portlet-fit bordered" id="general">
                                <div id="workflows" class="portlet-body">
                                    ...
                                    <table id="egaTable" class="table table-striped table-hover table-bordered"></table>
                                </div>
                            </div>
